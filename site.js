...
function renderNav(activePage) {
  ...
  nav.innerHTML = `
    <a href="index.html" class="nav-logo">Cannabis<span>Farm</span></a>
    <ul class="nav-links" id="navLinks">
      <li><a href="index.html#topics" class="${activePage==='topics'?'active':''}">Topics</a></li>
      <li><a href="index.html#guide" class="${activePage==='guide'?'active':''}">Beginner Guide</a></li>
      <li><a href="index.html#videos" class="${activePage==='videos'?'active':''}">Videos</a></li>
      <li><a href="index.html#glossary" class="${activePage==='glossary'?'active':''}">Glossary</a></li>
    </ul>
  ...
  footer.innerHTML = `
    <div class="footer-top">
      ...
      <div class="footer-col">
        <h5>Learn</h5>
        <ul>
          <li><a href="index.html#guide">Beginner Guide</a></li>
          <li><a href="index.html#topics">All Topics</a></li>
          <li><a href="index.html#videos">Video Library</a></li>
        </ul>
      </div>
      <div class="footer-col">
        <h5>Reference</h5>
